...
public class TestHQLHibernateRequeteParametree {
	// Cette bibliothèque fetch deux fois mais une seule reqête est exécutée :
	public static void main(String[] args) {		
		myObjHibParameterized unObjHib = new myObjHibParameterized("Legume");
...
class myObjHibParameterized {
	
	private String sPrivTypeAliment ;
	public myObjHibParameterized(String sArgTypeAliment) {
		
		this.sPrivTypeAliment = sArgTypeAliment ;
	} 
	...
	public void runFetchOperation(Session ArgMySess ) { 
		...
		Query<TableDenrees> myHQLquery = ArgMySess.createQuery("from TableDenrees where TypeDenree = :L") ;
		myHQLquery.setParameter("L", sPrivTypeAliment);
